    ...
    <Tab.Container id="left-tabs" defaultActiveKey="first" >
        <Row>
            ...
            <Tab.Content className="text-white">
                ...
                <Image src="https://cdn.pixabay.com/photo/2017/05/16/11/45/blue-waves-2317606_960_720.png" style={{width:'120%'}} />
                </Tab.Pane>
                ...
                <Image src="https://3.bp.blogspot.com/-pMdS5_O0jPM/T0CjHAWeZ9I/AAAAAAAAGwE/jBM4mdulfNA/s1600/nubes2.png" style={{width:'120%'}}  />
                </Tab.Pane>
            </Tab.Content>
            </Col>
        </Row>
